...
const MoodBoardApp = () => {
  ...
  const [slides, setSlides] = useState<Slide[]>([{ id: 1, layers: [] }]);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <header className="glass-effect border-b border-gray-700/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Second row - Context-specific controls for Mood Board */}
          {activeTab === 'moodboard' && (
            <div className="flex items-center justify-between pb-4 border-t border-gray-700/30 pt-4">
              {/* Left side - Settings and mode controls */}
              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-2">
                  <span className="text-sm text-gray-300 whitespace-nowrap">Background:</span>
                  <select
                    value={backgroundRemovalAlgorithm}
                    onChange={(e) => setBackgroundRemovalAlgorithm(e.target.value as 'ai' | 'grabcut' | 'simple')}
                    className="px-2 py-1 text-xs border border-gray-600 rounded bg-gray-700 text-white focus:border-purple-500 focus:ring-1 focus:ring-purple-500"
                  >
                    <option value="ai">AI</option>
                    <option value="grabcut">Advanced</option>
                    <option value="simple">Simple</option>
                  </select>
                  
                  {backgroundRemovalAlgorithm === 'ai' && (
                    <select
                      value={rembgModel}
                    ...
                    >
                      <option value="u2net">General</option>
                      <option value="u2net_human_seg">Human</option>
                      <option value="u2net_cloth_seg">Cloth</option>
                ...
                <div className="flex items-center space-x-2 ml-4">
                  <button
                    ...
                    className={viewMode === 'grid' ? 'btn-gradient text-sm px-3 py-1' : 'btn-gradient-outline text-sm px-3 py-1'}
                  >
                    <Grid className="w-4 h-4" />
                    <span className="ml-1 whitespace-nowrap">Grid</span>
                  </button>
                  ...
                  <button
                    ...
                    className={viewMode === 'slideshow' ? 'btn-gradient text-sm px-3 py-1' : 'btn-gradient-outline text-sm px-3 py-1'}
                  >
                    <Layers className="w-4 h-4" />
                    <span className="ml-1 whitespace-nowrap">Slideshow</span>
                  </button>
                  ...
                  <button
                    ...
                    className={viewMode === 'preview' ? 'btn-gradient text-sm px-3 py-1' : 'btn-gradient-outline text-sm px-3 py-1'}
                    disabled={slides.length === 0 || slides.every(s => s.layers.length === 0)}
                  >
                    <Play className="w-4 h-4" />
                    <span className="ml-1 whitespace-nowrap">Preview</span>
                  </button>
                </div>
                                  ...
                                  <div className="flex items-center space-x-2">
                                    ...
                                    <div className="flex flex-col space-y-1">
                                      <button
                                        ...
                                        disabled={layer.zIndex === currentSlideData.layers.length - 1}
                    ...
                    <div className="flex-1">
                      <div className="card-dark rounded-lg shadow-lg p-4">
                        ...
                        <div 
                          ...
                          className="relative w-full h-96 bg-gray-800 border-2 border-dashed border-gray-600 rounded-lg overflow-hidden"
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="flex space-x-2 pt-2">
                                <button
                                  ...
                                  disabled={layer.zIndex === (currentSlideData?.layers.length || 1) - 1}
